...
const Loader = () => {
  return (
    <div>
      <button
        className="inline-flex h-12 items-center justify-center gap-2.5 rounded-lg border border-stroke bg-transparent px-6 py-3 text-base font-medium text-dark dark:border-dark-3 dark:text-white mx-16"
        disabled
      >
        <span>
          <svg
          ...
          >
            <circle cx="10" cy="10" r="9" stroke="#E5E7EB" stroke-width="2" />
