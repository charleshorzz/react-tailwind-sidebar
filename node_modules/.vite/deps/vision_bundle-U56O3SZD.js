...
var hn;
function un() {
  return hn != null ? hn : hn = new Ve($t([]), void 0, void 0, void 0, ue);
}
function ln(t2) {
  t2 = Nt(t2);
...
function Wn(t2, e2, n2) {
  ...
  if (r2) {
    const n3 = r2[zn];
    i2 = n3 ? n3.K : Re(r2[0]), t2[e2] = n3 != null ? n3 : r2;
  }
...
var vs = class extends Cn {
  ...
  g() {
    var _a2;
    return (_a2 = ye(tn(this, 2))) != null ? _a2 : false;
  }
};
...
function mo(t2, e2 = -1, n2 = "") {
  return { categories: t2.map((t3) => {
    ...
    return { index: (_a2 = Fn(Sn(t3, 1))) != null ? _a2 : -1, score: (_b = Ln(t3, 2)) != null ? _b : 0, categoryName: (_d = (_c2 = xn(t3, 3)) != null ? _c2 : "") != null ? _d : "", displayName: (_f = (_e2 = xn(t3, 4)) != null ? _e2 : "") != null ? _f : "" };
...
function yo(t2) {
  ...
  if ((e2 = (_d = _n(t2, Ui, 4)) == null ? void 0 : _d.h()) && (s2.boundingBox = { originX: (_e2 = Sn(e2, 1)) != null ? _e2 : 0, originY: (_f = Sn(e2, 2)) != null ? _f : 0, width: (_g = Sn(e2, 3)) != null ? _g : 0, height: (_h = Sn(e2, 4)) != null ? _h : 0, angle: 0 }), (_i2 = _n(t2, Ui, 4)) == null ? void 0 : _i2.g().length)
    for (const e3 of _n(t2, Ui, 4).g())
      s2.keypoints.push({ x: (_j = on(e3, 1)) != null ? _j : 0, y: (_k = on(e3, 2)) != null ? _k : 0, score: (_l = on(e3, 4)) != null ? _l : 0, label: (_m = xn(e3, 3)) != null ? _m : "" });
  return s2;
}
function vo(t2) {
  var _a2, _b, _c2;
  ...
  for (const n2 of bn(t2, Hi, 1))
    e2.push({ x: (_a2 = Ln(n2, 1)) != null ? _a2 : 0, y: (_b = Ln(n2, 2)) != null ? _b : 0, z: (_c2 = Ln(n2, 3)) != null ? _c2 : 0 });
  return e2;
}
function _o(t2) {
  var _a2, _b, _c2;
...
async function Ma(t2, e2, n2) {
  ...
  }(t2, (_a2 = n2.canvas) != null ? _a2 : "undefined" == typeof OffscreenCanvas || xo() ? document.createElement("canvas") : void 0, e2, n2);
}
function Oa(t2, e2, n2, r2) {
  ...
  t2.g.pa(e2, t2.ma, r2 != null ? r2 : performance.now()), t2.finishProcessing();
}
...
var Da = class extends Ra {
  ...
  o(t2) {
    var _a2, _b;
    return "minDetectionConfidence" in t2 && Pn(this.h, 2, (_a2 = t2.minDetectionConfidence) != null ? _a2 : 0.5), "minSuppressionThreshold" in t2 && Pn(this.h, 3, (_b = t2.minSuppressionThreshold) != null ? _b : 0.3), this.l(t2);
  }
  F(t2, e2) {
...
var Ka = class extends Ra {
  ...
  o(t2) {
    var _a2, _b, _c2, _d;
    return "numFaces" in t2 && On(this.u, 4, (_a2 = t2.numFaces) != null ? _a2 : 1), "minFaceDetectionConfidence" in t2 && Pn(this.u, 2, (_b = t2.minFaceDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Pn(this.h, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minFacePresenceConfidence" in t2 && Pn(this.v, 2, (_d = t2.minFacePresenceConfidence) != null ? _d : 0.5), "outputFaceBlendshapes" in t2 && (this.outputFaceBlendshapes = !!t2.outputFaceBlendshapes), "outputFacialTransformationMatrixes" in t2 && (this.outputFacialTransformationMatrixes = !!t2.outputFacialTransformationMatrixes), this.l(t2);
  }
  F(t2, e2) {
  ...
  m() {
    ...
    ui(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), _i(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      ...
      if (this.outputFaceBlendshapes)
        for (const e4 of t3)
          t3 = Mi(e4), this.j.faceBlendshapes.push(mo((_a2 = t3.g()) != null ? _a2 : []));
      Bo(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes)
        for (const e4 of t3)
          (t3 = _n(ks(e4), qi, 2)) && this.j.facialTransformationMatrixes.push({ rows: (_a2 = Fn(Sn(t3, 1))) != null ? _a2 : 0, columns: (_b = Fn(Sn(t3, 2))) != null ? _b : 0, data: (_c2 = cn(t3, 3, me)) != null ? _c2 : [] });
      Bo(this, e3);
...
var $a = class extends Ra {
  ...
  Pa(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, Pa(this, t2, r2 != null ? r2 : {}), !this.h)
      return this.u;
  }
  m() {
    var t2 = new Ei();
...
function Qa(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && null != Sn(n3, 1) ? Fn(Sn(n3, 1)) : -1, t2.push({ score: (_a2 = Ln(n3, 2)) != null ? _a2 : 0, index: r2, categoryName: (_c2 = (_b = xn(n3, 3)) != null ? _b : "") != null ? _c2 : "", displayName: (_e2 = (_d = xn(n3, 4)) != null ? _d : "") != null ? _e2 : "" });
    n2.push(t2);
  }
  return n2;
}
var tc = class extends Ra {
  ...
  o(t2) {
    ...
    if (On(this.h, 3, (_a2 = t2.numHands) != null ? _a2 : 1), "minHandDetectionConfidence" in t2 && Pn(this.h, 2, (_b = t2.minHandDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Pn(this.C, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minHandPresenceConfidence" in t2 && Pn(this.u, 2, (_d = t2.minHandPresenceConfidence) != null ? _d : 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new Cs(), n2 = go(t2.cannedGesturesClassifierOptions, (_e2 = _n(this.j, Cs, 3)) == null ? void 0 : _e2.h());
      En(e2, 0, 2, n2), En(this.j, 0, 3, e2);
    } else
      void 0 === t2.cannedGesturesClassifierOptions && ((_f = _n(this.j, Cs, 3)) == null ? void 0 : _f.g());
    return t2.customGesturesClassifierOptions ? (En(e2 = new Cs(), 0, 2, n2 = go(t2.customGesturesClassifierOptions, (_g = _n(this.j, Cs, 4)) == null ? void 0 : _g.h())), En(this.j, 0, 4, e2)) : void 0 === t2.customGesturesClassifierOptions && ((_h = _n(this.j, Cs, 4)) == null ? void 0 : _h.g()), this.l(t2);
  }
  Ka(t2, e2) {
    ...
    ui(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "HAND_GESTURES:hand_gestures"), fi(n2, "LANDMARKS:hand_landmarks"), fi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), fi(n2, "HANDEDNESS:handedness"), n2.o(e2), _i(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of bn(t3, Hi, 1))
          n3.push({ x: (_a2 = Ln(e5, 1)) != null ? _a2 : 0, y: (_b = Ln(e5, 2)) != null ? _b : 0, z: (_c2 = Ln(e5, 3)) != null ? _c2 : 0 });
...
var nc = class extends Ra {
  ...
  o(t2) {
    var _a2, _b, _c2, _d;
    return "numHands" in t2 && On(this.h, 3, (_a2 = t2.numHands) != null ? _a2 : 1), "minHandDetectionConfidence" in t2 && Pn(this.h, 2, (_b = t2.minHandDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Pn(this.j, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minHandPresenceConfidence" in t2 && Pn(this.u, 2, (_d = t2.minHandPresenceConfidence) != null ? _d : 0.5), this.l(t2);
  }
  F(t2, e2) {
    ...
    ui(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "LANDMARKS:hand_landmarks"), fi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), fi(n2, "HANDEDNESS:handedness"), n2.o(e2), _i(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of t3.g())
          n4.push({ score: (_a2 = Ln(e5, 2)) != null ? _a2 : 0, index: (_b = Fn(Sn(e5, 1))) != null ? _b : -1, categoryName: (_d = (_c2 = xn(e5, 3)) != null ? _c2 : "") != null ? _d : "", displayName: (_f = (_e2 = xn(e5, 4)) != null ? _e2 : "") != null ? _f : "" });
        i2.push(n4);
      }
    ...
    ui(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), li(n2, "IMAGE:input_image"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), _i(t2, n2), this.g.attachProtoListener("classifications", (t3, e3) => {
      this.j = function(t4) {
        const e4 = { classifications: bn(t4, Qi, 1).map((t5) => {
          var _a2, _b, _c2;
          return mo((_b = (_a2 = _n(t5, Fi, 4)) == null ? void 0 : _a2.g()) != null ? _b : [], Fn(Sn(t5, 2)), (_c2 = xn(t5, 3)) != null ? _c2 : "");
        }) };
    ...
    ui(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), li(n2, "IMAGE:image_in"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), _i(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = hs(t3), this.embeddings = function(t4) {
        return { embeddings: bn(t4, ss, 1).map((t5) => {
          var _a2, _b, _c2, _d, _e2, _f;
          const e4 = { headIndex: (_a2 = Fn(Sn(t5, 3))) != null ? _a2 : -1, headName: (_c2 = (_b = xn(t5, 4)) != null ? _b : "") != null ? _c2 : "" };
          if (void 0 !== vn(t5, rs, gn(t5, 1)))
            t5 = cn(t5 = _n(t5, rs, gn(t5, 1)), 1, me), e4.floatEmbedding = t5;
          else {
            const n3 = new Uint8Array(0);
            e4.quantizedEmbedding = (_f = (_e2 = (_d = _n(t5, is, gn(t5, 2))) == null ? void 0 : _d.oa()) == null ? void 0 : _e2.qa()) != null ? _f : n3;
          }
          return e4;
...
var cc = class extends Ra {
  ...
  o(t2) {
    var _a2, _b;
    return void 0 !== t2.displayNamesLocale ? nn(this.h, 2, Se(t2.displayNamesLocale)) : "displayNamesLocale" in t2 && nn(this.h, 2), "outputCategoryMask" in t2 && (this.outputCategoryMask = (_a2 = t2.outputCategoryMask) != null ? _a2 : false), "outputConfidenceMasks" in t2 && (this.outputConfidenceMasks = (_b = t2.outputConfidenceMasks) != null ? _b : true), super.l(t2);
  }
  V() {
    !function(t2) {
      var _a2, _b, _c2;
      const e2 = bn(t2.aa(), di, 1).filter((t3) => {
        var _a3;
        return ((_a3 = xn(t3, 1)) != null ? _a3 : "").includes("mediapipe.tasks.TensorsToSegmentationCalculator");
      });
      if (t2.u = [], 1 < e2.length)
        throw Error("The graph has more than one mediapipe.tasks.TensorsToSegmentationCalculator.");
      1 === e2.length && ((_c2 = (_b = (_a2 = _n(e2[0], ni, 7)) == null ? void 0 : _a2.l()) == null ? void 0 : _b.g()) != null ? _c2 : /* @__PURE__ */ new Map()).forEach((e3, n2) => {
        var _a3;
        t2.u[Number(n2)] = (_a3 = xn(e3, 1)) != null ? _a3 : "";
      });
    }(this);
  }
  ba(t2, e2, n2) {
...
var Ic = class extends Ra {
  ...
  o(t2) {
    var _a2, _b, _c2, _d, _e2;
    return "numPoses" in t2 && On(this.j, 4, (_a2 = t2.numPoses) != null ? _a2 : 1), "minPoseDetectionConfidence" in t2 && Pn(this.j, 2, (_b = t2.minPoseDetectionConfidence) != null ? _b : 0.5), "minTrackingConfidence" in t2 && Pn(this.h, 4, (_c2 = t2.minTrackingConfidence) != null ? _c2 : 0.5), "minPosePresenceConfidence" in t2 && Pn(this.C, 2, (_d = t2.minPosePresenceConfidence) != null ? _d : 0.5), "outputSegmentationMasks" in t2 && (this.outputSegmentationMasks = (_e2 = t2.outputSegmentationMasks) != null ? _e2 : false), this.l(t2);
  }
  F(t2, e2, n2) {
    const r2 = "function" != typeof e2 ? e2 : {};
...
//# sourceMappingURL=vision_bundle-U56O3SZD.js.map
