import {
  require_classnames
} from "./chunk-T7C6XXJL.js";
import {
  require_react_dom
} from "./chunk-WM63XKD4.js";
import {
  require_jsx_runtime
} from "./chunk-C4RLRGFC.js";
import {
  require_react
...
// node_modules/flowbite-react/node_modules/debounce/index.js
var require_debounce = __commonJS({
  "node_modules/flowbite-react/node_modules/debounce/index.js"(exports, module) {
    ...
    return (0, import_jsx_runtime12.jsx)(
      ButtonBase,
      {
        ...
        className: twMerge(
          ...
          outline && ((_a = theme2.outline.color[color]) != null ? _a : theme2.outline.color.default),
...
var Image = ({ theme: customTheme = {}, ...props }) => {
  ...
  if (props.renderImage) {
    return props.renderImage(theme2, (_a = props.horizontal) != null ? _a : false);
  }
  if (props.imgSrc) {
...
var useThemeMode = () => {
  ...
  const clearMode = () => {
    var _a;
    const newMode = (_a = getThemeMode()) != null ? _a : DEFAULT_MODE;
    handleSetMode(newMode);
  };
...
var getInitialMode = (defaultMode) => {
  ...
  return (_a = LSMode != null ? LSMode : defaultMode) != null ? _a : DEFAULT_MODE;
};
...
var HelperText = ({
  ...
  return (0, import_jsx_runtime23.jsx)("p", { className: twMerge(theme2.root.base, theme2.root.colors[color], className), ...props, children: (_a = value != null ? value : children) != null ? _a : "" });
};
...
// node_modules/flowbite-react/node_modules/@floating-ui/react/utils/floating-ui.react.utils.esm.js
...
function FloatingFocusManager(props) {
  ...
  index2(() => {
    ...
    return () => {
      ...
      if (returnFocusRef.current && !preventReturnFocusRef.current && isHTMLElement(returnElement) && (returnElement !== activeEl && activeEl !== doc.body ? isFocusInsideFloatingTree : true)) {
...
function useDismiss(context, props) {
  ...
  const closeOnPressOutside = useEffectEvent((event) => {
    ...
    if (markers.length && isElement(target) && !isRootElement(target) && !contains(target, floating) && Array.from(markers).every((marker) => !contains(targetRootAncestor, marker))) {
      return;
    }
...
var DropdownDivider = ({ className, theme: customTheme = {}, ...props }) => {
  ...
  const theme2 = (_a = customTheme.divider) != null ? _a : rootTheme.floating.divider;
...
var DropdownHeader = ({ children, className, theme: customTheme = {}, ...props }) => {
  var _a;
  const { theme: rootTheme } = useDropdownContext();
  const theme2 = (_a = customTheme.header) != null ? _a : rootTheme.floating.header;
...
var DropdownComponent = ({
  ...
  const Icon = (0, import_react30.useMemo)(() => {
    ...
    return (_a = icons[p]) != null ? _a : HiOutlineChevronDown;
  }, [placement]);
...
var Label = ({
  ...
  return (0, import_jsx_runtime50.jsx)(
    "label",
    {
      ...
      ...props,
      children: (_a = value != null ? value : children) != null ? _a : ""
    }
  );
};
    ...
    return (0, import_jsx_runtime81.jsx)(ListItem2, { theme: theme2, className: theme2.listItem, id, isCollapsed, tooltipChildren: children, children: (0, import_jsx_runtime81.jsxs)(
      Component,
      {
        ...
        children: [
          ...
          isCollapsed && !Icon && (0, import_jsx_runtime81.jsx)("span", { className: (_d = theme2.collapsed) == null ? void 0 : _d.noIcon, children: (_e = children.charAt(0).toLocaleUpperCase()) != null ? _e : "?" }),
