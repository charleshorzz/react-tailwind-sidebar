...
function configureStore(options) {
  ...
  if (devTools) {
    finalCompose = composeWithDevTools(__spreadValues3({
      trace: !IS_PRODUCTION
...
var createAsyncThunk = (() => {
  function createAsyncThunk2(typePrefix, payloadCreator, options) {
    const fulfilled = createAction(typePrefix + "/fulfilled", (payload, requestId, arg, meta) => ({
      payload,
      meta: __spreadProps(__spreadValues3({}, meta || {}), {
        arg,
        requestId,
...
function buildCreateSlice({
  ...
  return function createSlice2(options) {
    ...
    function buildReducer() {
      ...
      const finalCaseReducers = __spreadValues3(__spreadValues3({}, extraReducers), context.sliceCaseReducersByType);
    ...
    const slice = __spreadProps(__spreadValues3({
      name,
      reducer,
      ...
      injectInto(injectable, _a2 = {}) {
        ...
        return __spreadValues3(__spreadValues3({}, slice), makeSelectorProps(newReducerPath, true));
      }
    });
    return slice;
  };
    ...
    updates.forEach((update) => {
      if (update.id in state.entities) {
        updatesPerEntity[update.id] = {
          id: update.id,
          changes: __spreadValues3(__spreadValues3({}, updatesPerEntity[update.id] ? updatesPerEntity[update.id].changes : null), update.changes)
        };
      }
    });
...
function createEntityAdapter(options = {}) {
  ...
  return __spreadValues3(__spreadValues3(__spreadValues3({
    selectId,
    sortComparer
...
//# sourceMappingURL=chunk-K2Z5CVVK.js.map
