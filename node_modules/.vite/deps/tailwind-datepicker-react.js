...
var require_DatePickerProvider = __commonJS({
  "node_modules/tailwind-datepicker-react/dist/Components/DatePickerProvider.js"(exports) {
    ...
    }, selectedDate: new Date(), changeSelectedDate: function() {
    ...
    var DatePickerProvider = function(param) {
      ...
      var ref1 = _slicedToArray(selectedDateState || (0, _react.useState)((options === null || options === void 0 ? void 0 : options.defaultDate) || new Date()), 2), selectedDate = ref1[0], setSelectedDate = ref1[1];
...
// dep:tailwind-datepicker-react
var tailwind_datepicker_react_default = require_dist2();
export {
  tailwind_datepicker_react_default as default
};
