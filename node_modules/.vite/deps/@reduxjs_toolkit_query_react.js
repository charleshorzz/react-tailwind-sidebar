...
function buildHooks({
  ...
  function usePrefetch(endpointName, defaultOptions) {
    ...
    return (0, import_react.useCallback)((arg, options) => dispatch(api.util.prefetch(endpointName, arg, __spreadValues(__spreadValues({}, stableDefaultOptions), options))), [endpointName, dispatch, stableDefaultOptions]);
  }
  function buildQueryHooks(name) {
    ...
    return {
      ...
      useQuery(arg, options) {
        ...
        return (0, import_react.useMemo)(() => __spreadValues(__spreadValues({}, queryStateResults), querySubscriptionResults), [queryStateResults, querySubscriptionResults]);
      }
    };
  }
  function buildMutationHook(name) {
    return ({
      ...
      const finalState = (0, import_react.useMemo)(() => __spreadProps(__spreadValues({}, currentState), {
        originalArgs,
        reset
